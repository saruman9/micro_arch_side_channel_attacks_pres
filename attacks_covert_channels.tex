\begin{frame}{\insertsubsection}
  ...
  \begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Скрытые каналы между процессорами}\label{covert_attack_example}
  \end{figure}
...
\begin{frame}{\insertsubsection}
  \begin{itemize}
  \item Атаки на кэш (использование разделяемой библиотеки)
  \item Row miss атака (DRAM)
  \item Тепловой канал
  \item Радио канал (без специализированного аппаратного обеспечения)
  \end{itemize}
