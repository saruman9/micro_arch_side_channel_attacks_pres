...
\subsubsection{Типы кэш-памяти}
\begin{frame}{\insertsubsubsection}
  \begin{itemize}
  \item кэш с прямым отображением (direct mapped cache)
  \item полностью ассоциативный кэш (fully associative cache)
  \item наборно-ассоциативный кэш (2/4/8/12-way set associative cache)
  \end{itemize}
  ...
  \begin{figure}[h]
    \begin{tikzpicture}[
      ...
      label = {
        ...
        \node[fill = black!30](cache_1_1){Тег 1-го пути}; \& \node[fill = black!30]{Данные 1-го пути}; \\
