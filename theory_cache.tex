...
\begin{frame}{\insertsubsection}
  ...
  \begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{The flow of data through a modern platform}\label{fig:proc_cache_arch}
  \end{figure}
...
\begin{frame}{\insertsubsection}
  ...
  \begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Algorithm of CPU cache}\label{fig:cache_manipulation_example}
  \end{figure}
  ...
  \begin{figure}[h]
    \begin{tikzpicture}[
      ...
      label = {
        ...
        \node[fill = black!30](cache_1_1){Way 1 Tag}; \& \node[fill = black!30]{Way 1 Data}; \\
        \node[fill = black!10]{Way 2 Tag}; \& \node[fill = black!10]{Way 2 Data}; \\
