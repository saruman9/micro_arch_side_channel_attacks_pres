...
\title[Введение в атаки по сторонним каналам]{Введение в атаки по сторонним
  каналам на микроархитектуру, основанные на исполнении кода}
...
\section{Абстрактный пример эксплуатации}
\input{exploitation}
